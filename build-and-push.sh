...
SERVICES=(
    ...
    "llm-gateway:0.2.48-v108-audience-first-search"
    "video-generation-service:0.2.77-internal-video-url"
    "post-production-service:0.1.29-film-staleness"
    "pre-production-service:0.2.45-audience-first-search"
    "critic-service:0.1.2-gemini-embedding-001"
    "creative-planning-service:0.1.24-audience-first-search"
