...
SERVICES=(
    ...
    "product-service:5.0.94-billing-subscription-flow"
    "billing-service:5.0.100-billing-subscription-flow"
    "llm-gateway:0.1.55-internal-models"
    "video-generation-service:0.2.10-internal-models"
    "post-production-service:0.1.7-billing-subscription-flow"
    "pre-production-service:0.2.19-billing-subscription-flow"
